# Shot List — Team/Human Introduction Reel (Day 6)
...
unavailable, Shot 3 stays on the talking-head.

## Website Screen Recording Requirements
None — this Reel does not feature a website.

## Source Assets Required
- One continuous or lightly-cut recording of a real team member speaking
  the script (any reasonably stable phone/camera recording is sufficient
  — production value is intentionally secondary to authenticity here).

SOURCE ASSET STATUS: **PENDING CAPTURE** — requires the owner/team to
record and provide footage; this is not obtainable through any technical
capability in this session (it requires a real person, not a website or
generation).
